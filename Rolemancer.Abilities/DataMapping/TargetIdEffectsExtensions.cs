...
namespace Rolemancer.Abilities.DataMapping
{
    ...
    {
        public static EffectComplexKey AttachEffect(this TargetId targetId, Effect effect)
        {
            var map = GetMap();
            return AttachEffect(targetId, effect, map);
        }
        public static EffectComplexKey AttachEffect(this TargetId targetId, Effect effect, DataMap map)
        {
        ...
        public static NativeHashMap<EffectComplexKey,Effect> GetEffects(this TargetId targetId,
        ...
        public static NativeHashMap<EffectComplexKey,Effect> GetEffects(this TargetId targetId, DataMap map,
            AllocatorManager.AllocatorHandle handle)
        {
