...
using Rolemancer.AbilityTools.ModifierProcessors;
using Rolemancer.AbilityTools.Targets;
using Rolemancer.AbilityTools.Tests.ConcreteModifierProcessors;
...
namespace Rolemancer.AbilityTools.Tests
{
    public class CreateEffectTest : MonoBehaviour
    {
        ...
        private void CreateBaseMaxHpEffect(TargetId target)
        {
            ...
            var buffHp = new Attribute(_maxHpKey) { Value = 7 };
        ...
        private void CreateMaxHpBuffEffect_Infinity(TargetId target)
        {
            ...
            var buffHp = new Attribute(_maxHpKey) { Value = 13 };
            complexKey.AttachAttributes(buffHp);
        }
        ...
        private void CreateMaxHpBuffEffect_Temporary(TargetId target)
        {
            ...
            var buffHp = new Attribute(_maxHpKey) { Value = 9 };
            complexKey.AttachAttributes(buffHp);
        }
        ...
        private void CreateDamageEffect(TargetId target)
        {
            ...
            var buffHp = new Attribute(_damageKey) { Value = 3 };
            complexKey.AttachAttributes(buffHp);
        }
