        ...
        private struct UpdateAttributes : IJob
        {
            ...
            private void PrepareArguments()
            {
                ...
                for (var i = 0; i < affectedTargets.Length; i++)
                {
                    ...
                    var diff = new DbKeysCollection<AttributeDbKey>(Allocator.Temp);
                    ...
                    Map.Attributes.ReplaceTargetAttributes(processorArguments.Target,
                        processorArguments.CurrentAttributes);
        ...
        private struct RemoveJob : IJob
        {
            ...
            public void Execute()
            {
                ...
                for (var i = 0; i < keys.Length; i++)
                {
                    ...
                    if (effect.Status == EffectStatus.Discarded) key.DestroyEffect(Map);
                }
